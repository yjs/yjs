    ...
    _createClass(AbstractDatabase, [{
      ...
      value: regeneratorRuntime.mark(function addToGarbageCollector(op, left) {
        ...
        return regeneratorRuntime.wrap(function addToGarbageCollector$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                if (!(op.gc == null && op.deleted === true && this.store.gc && this.store.y.connector.isSynced)) {
                  _context3.next = 15;
                  break;
                }
      ...
      */
      ...
      value: regeneratorRuntime.mark(function operationAdded(transaction, op) {
        var type, opLen, i, sid, l, key, listener, t, parentIsDeleted, o, len, startId, _i2, id, opIsDeleted, delop;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                type = this.initializedTypes[JSON.stringify(op.targetParent)];
                ...
                return _context8.delegateYield(type._changed(transaction, op), 't0', 4);
              ...
              case 6:
                return _context8.delegateYield(transaction.updateState(op.id[0]), 't1', 7);
              ...
              case 7:
                ...
                return _context8.delegateYield(transaction.isDeleted(op.parent), 't2', 12);

              case 12:
                parentIsDeleted = _context8.t2;
                ...
                return _context8.delegateYield(transaction.deleteList(op.id), 't3', 15);
              ...
              case 16:
                ...
                return _context8.delegateYield(t._changed(transaction, o), 't4', 19);
              ...
              case 23:
                ...
                return _context8.delegateYield(transaction.isDeleted(id), 't5', 26);

              case 26:
                opIsDeleted = _context8.t5;
                ...
                return _context8.delegateYield(this.tryExecute.call(transaction, delop), 't6', 30);
  ...
  var Struct = {
    ...
    */
    ...
    Insert: {
      ...
      */
      execute: regeneratorRuntime.mark(function execute(op) {
        var i, tryToRemergeLater, origin, distanceToOrigin, o, parent, start, startId, oOriginDistance, left, right, m;
        return regeneratorRuntime.wrap(function execute$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 101:
                if (!(i < tryToRemergeLater.length)) {
                  _context3.next = 108;
                  break;
                }

                return _context3.delegateYield(this.getOperation(tryToRemergeLater[i]), 't22', 103);
        ...
        return regeneratorRuntime.wrap(function applyCreatedOperations$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 9:
                if (this.store.y.connector.isSynced && send.length > 0) {
...
function Y(opts /* :YOptions */) /* :Promise<YConfig> */{
  ...
  return new Promise(function (resolve, reject) {
    if (opts == null) reject('An options object is expected! ');else if (opts.connector == null) reject('You must specify a connector! (missing connector property)');else if (opts.connector.name == null) reject('You must specify connector name! (missing connector.name property)');else if (opts.db == null) reject('You must specify a database! (missing db property)');else if (opts.connector.name == null) reject('You must specify db name! (missing db.name property)');else {
