          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 29:
                ...
                return _context7.delegateYield(this.getOperation(opid), 't7', 31);

              case 31:
                op = _context7.t7;

              case 32:
                return _context7.delegateYield(this.tryCombineWithLeft(op), 't8', 33);
    ...
    */
    ...
    var SmallLookupBuffer = function (_Store) {
      ...
      function SmallLookupBuffer(arg1, arg2) {
        ...
        var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(SmallLookupBuffer).call(this, arg1, arg2));
        // super(...arguments) -- do this when this is supported by stable nodejs


        _this3.writeBuffer = createEmptyOpsArray(5);
        _this3.readBuffer = createEmptyOpsArray(10);
        return _this3;
      }
