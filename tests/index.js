...
import * as undoArrayBug from './undo-array-bug.tests.js'
 ...
 */
const tests = {
  doc, map, array, text, xml, encoding, undoredo, undoArrayBug, compatibility, snapshot, updates, relativePositions
}
